...
public class SimpleAutonomous extends LinearOpMode {
    ...
    private static final double[] RED_AUDIENCE_START = {36, 15};
    private static final double[] RED_GOAL_START = {36, 120};
    private static final double[] BLUE_AUDIENCE_START = {108, 15};
    private static final double[] BLUE_GOAL_START = {108, 120};
    
    // Spike mark positions (3 per alliance)
    private static final double[] RED_SPIKE_NEAR = {30, 48};
    private static final double[] RED_SPIKE_MIDDLE = {30, 72};
    private static final double[] RED_SPIKE_FAR = {30, 96};
    
    private static final double[] BLUE_SPIKE_NEAR = {114, 48};
    private static final double[] BLUE_SPIKE_MIDDLE = {114, 72};
    private static final double[] BLUE_SPIKE_FAR = {114, 96};
    
    // Goal positions
    private static final double[] RED_GOAL = {36, 144};
    private static final double[] BLUE_GOAL = {108, 144};
